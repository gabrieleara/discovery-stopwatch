...
function setup(block)
  %% GLOBAL VARIABLES ARE NEEDED TO STORE LOGICAL STATE OF THE BUTTONS
  global timebutton
  ...
  %% Register methods
  %% THESE PARTS ARE OPTIONAL, IF I DON'T NEED THEM I CAN SKIP THIS OF COURSE
  ...
  %% NEED TO DO IT, NOBODY KNOWS WHY. COPYPASTE AND YOU ARE OK
 function SetInputPortSamplingMode(block, idx, fd)
   block.InputPort(idx).SamplingMode = fd;

 
function ButtonDown(hObj,evnt)
   %% SAME GLOBALS AS BEFORE, BUT YOU NEED TO REDECLARE THEM IN EACH
   %% FUNCTION
   global timebutton
   global timesetbutton
   global alarmbutton
...
function Start(block) 
  %% CALLED AT SIMULATION INITIALIZATION
  %% YOU NEED TO CREATE THE GRAPHICAL INTERFACE AND INITIALIZE ALL VALUES
  %% ALSO BUTTONS SHOULD BE INITIALIZED HERE, BIT IT WORKS SO WE DON'T
...
% skipping Arial
  ...
  %% PREPARING THE AREA WE WANT TO PLACE THE ICONS
  %% THE AXES ARE USED TO SELECT THE AREA WHERE TO PLACE ICONS
